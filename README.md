...
외부 라이브러리는 창 생성, 미디어 디코딩, 이미지 파일 입출력, 터미널 입력, OpenGL 접근에만 사용했습니다.
...
28개 이미지/영상 처리 알고리즘을 적용할 수 있습니다.
...
이 프로그램은 SDL 키보드 단축키와 터미널 명령을 모두 지원합니다.
